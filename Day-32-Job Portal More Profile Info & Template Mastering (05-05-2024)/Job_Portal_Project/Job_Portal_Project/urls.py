...
from Job_Portal_Project.views import signup,signin,dashboard,logoutpage,addjob,deletejob,viewsinglejob,profile,editjob,updatejob,appliedjob,postedjob,editprofile,profiles_info,recruiterbasicinfo,recruitercontact,seekerbasicinfo,seekercontact,seekereducation,seekerworkex
