...
from recipeProject.views import signup,signin,dashboard,logoutpage,profile,addrecipe,viewallrecipe,singlerecipeview,deleterecipe,editrecipe,udpaterecipe
